...
For i = 1 To frmMain.lvwLog.ListItems.Count
    If Addr = frmMain.lvwLog.ListItems(i).Text And LocP = frmMain.lvwLog.ListItems(i).ListSubItems(1) And Status = frmMain.lvwLog.ListItems(i).ListSubItems(3) Then Exit Sub
Next
ByPassLoop:
